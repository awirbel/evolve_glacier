...
# Define FunctionsSpaces on this mesh including Bubble-enriched Function Spaces
B = FiniteElement("Bubble",   Rmesh.ufl_cell(), 4)
Q31 = FiniteElement("Lagrange", Rmesh.ufl_cell(), 1)
M = FunctionSpace(Rmesh, B + Q31)
...
du, v = TrialFunction(M), TestFunction(M)
u = Function(M)
u_cg = Function(Q3)
...
Smax = project(constraint_u, M)
# lower constraint is the bed elevation + bed_diff1
Smin1 = s_new_bed
Smin = project(Smin1, M)
...
write_surface_v2(u_cg, s_new_bed_ini)
